...
Предупреждение: Перед прохождением этого курса желательно иметь базовые навыки работы с терминалом (командной строкой).
...
![images/versioning-by-number.png](images/versioning-by-number.png)
...
![images/versioning-by-number.png](images/versioning-by-time.png)
...
Итак, мы построили какую-то систему хранения версий проекта, которая позволяет:
